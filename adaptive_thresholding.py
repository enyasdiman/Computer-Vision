# -*- coding: utf-8 -*-
"""
Created on Wed Jul 20 13:36:02 2022
...
img = cv2.imread("C:/Users/enyas/YOLO/book_page.jpg")

_, threshold = cv2.threshold(img, 155, 255, cv2.THRESH_BINARY)

img_gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)

mean_c = cv2.adaptiveThreshold(img_gray, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY, 11, 12) #METHOD,TYPE,ODD NUMBER
